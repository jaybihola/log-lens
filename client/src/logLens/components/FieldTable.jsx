...
// found it here or in the sidebar. Actions live inline at the end of the
// value cell rather than in their own column — a column that's empty except
            ...
            <tr key={row.label}>
              ...
              <td>
                <div className="field-value-row">
                  <span className="field-value-text">{row.value}</span>
